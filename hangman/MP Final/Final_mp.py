...
# setting sound specs 44100, -16, 1, 512
...
button_click=pygame.mixer.Sound('3buttonclicksound.wav')
correct_sound=pygame.mixer.Sound('4correctsound.wav')
win_sound= pygame.mixer.Sound('2winsound.wav')
wrong_sound=pygame.mixer.Sound('5wrongsound.wav')
letter_repeat=pygame.mixer.Sound('1samelettersound.wav')
lose_sound=pygame.mixer.Sound('6lose_sound.wav')
...
def play(wins, losses):
    ...
    words = {
        ...
        "Musicians":["guitar","flute","drums","sitar","tabla","violin","piano", "xylophone"],
        "Furniture":["chair", "table", "closet", "cupboard", "cabinet", "bed", "fan", "nightstand", "clock", "bookshelf"],
        "University":["course","major","textbook","professor", "student","examination","project","cafeteria","library","classroom","lecture"]
    }
